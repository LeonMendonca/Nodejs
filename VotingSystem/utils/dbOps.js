...
async function createUser(userData) {
  try {
    ...
    const result = await pool.query(`INSERT INTO regvoters VALUES ('${id}', '${userData.firstname}', '${userData.lastname}', 
    '${userData.gender}', '${userData.date}' ,'${userData.username}', '${hashedPassword}', '${userData.currentaddress}', 
